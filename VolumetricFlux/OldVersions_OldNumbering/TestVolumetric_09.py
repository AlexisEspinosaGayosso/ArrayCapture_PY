...
####for ii in range(0,NCylinders):
    ...
    outputName=os.path.join(outRpDir, (formatRp % rpHere) + "_" + baseName + "_VolumetricFlux"+".dat") 
    backupName=os.path.join(outRpDir, (formatRp % rpHere) + "_" + baseName + "_VolumetricFlux" + ".dat"+".bak") 
    print(outputName)
